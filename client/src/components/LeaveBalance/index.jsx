      ...
      <div className="flex flex-col items-center">
        <div className="flex mt-2 gap-10">
          ...
          {user?.leaveBalance?.Maternity === 0 ? null : (
            <div className="flex flex-col items-center">
              <h2 className="font-semibold">
                {user?.leaveBalance?.Maternity}/10
              </h2>
          ...
          {user?.leaveBalance?.BroughtForward === 0 ? null : (
            <div className="flex flex-col items-center">
              <h2 className="font-semibold">
                {user?.leaveBalance?.BroughtForward}/4
              </h2>
          ...
          {user?.leaveBalance?.Duty === 0 ? null : (
            <div className="flex flex-col items-center">
              <h2 className="font-semibold">
                {user?.leaveBalance?.Duty}/{user?.leaveBalance?.Duty}
              </h2>
              <p className="text-[#707070]">Duty</p>
            </div>
          )}
          {user?.leaveBalance?.NoPay === 0 ? null : (
            <div className="flex flex-col items-center">
              <h2 className="font-semibold">
                {user?.leaveBalance?.NoPay}/{user?.leaveBalance?.NoPay}
              </h2>
              <p className="text-[#707070]">NoPay</p>
            </div>
          )}
        </div>
      </div>
